...
import com.errorhorse.bizzarebijouteries.block.entity.ModBlockEntities;
...
public class BizzareBijouteries {
    ...
    public BizzareBijouteries(IEventBus modEventBus, ModContainer modContainer) {
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event) {
        ...
        if (event.getTabKey() == CreativeModeTabs .FUNCTIONAL_BLOCKS) {
            event.accept(ModBlocks.MAGICAL_BARREL);
        }
    }
